...
using Druware.Server.Content.Entities.Configuration.Microsoft;
...
public class ContentContextMicrosoft : DbContext, IContentContext
{
    private readonly IConfiguration? _configuration;

    public ContentContextMicrosoft() { }

    public ContentContextMicrosoft(IConfiguration? configuration) =>
        _configuration = configuration;

    public ContentContextMicrosoft(DbContextOptions<ContentContextMicrosoft> options,

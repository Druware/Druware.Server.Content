...
using Druware.Server.Content.Entities.Configuration.PostgreSql;
...
public class ContentContextPostgreSql : DbContext, IContentContext
{
    ...
    public ContentContextPostgreSql(IConfiguration? configuration) =>
        _configuration = configuration;

    public ContentContextPostgreSql(DbContextOptions<ContentContextPostgreSql> options,
